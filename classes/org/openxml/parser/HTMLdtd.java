    ...
    public static boolean isClosing( String tagName, String openTag )
    {
        ...
        if ( openTag.equals( "HEAD" ) )
            return ! ( tagName.equals( "ISINDEX" ) || tagName.equals( "TITLE" ) ||
                       ...
                       tagName.equals( "BASE" ) || tagName.equals( "MAP" ) ||
                       tagName.equals( "NOSCRIPT" ) );
        
        // P (P, H1-H6, UL, OL, DL, PRE, DIV, BLOCKQUOTE, FORM, HR, TABLE, ADDRESS, FIELDSET,
        // closing BODY, closing HTML, end of document)
        if ( openTag.equals( "P" ) )
            return ( tagName.equals( "P" ) || tagName.equals( "H1" ) ||
                     tagName.equals( "H2" ) || tagName.equals( "H3" ) ||
                     tagName.equals( "H4" ) || tagName.equals( "H5" ) ||
                     tagName.equals( "H6" ) || tagName.equals( "UL" ) ||
                     tagName.equals( "OL" ) || tagName.equals( "DL" ) ||
                     tagName.equals( "PRE" ) || tagName.equals( "DIV" ) ||
                     tagName.equals( "BLOCKQUOTE" ) || tagName.equals( "FORM" ) ||
                     tagName.equals( "HR" ) || tagName.equals( "TABLE" ) ||
                     tagName.equals( "ADDRESS" ) || tagName.equals( "FIELDSET" ) ||
                     tagName.equals( "LI" ) || tagName.equals( "DD" ) ||
                     tagName.equals( "DT" ) );
        // DT (DD)
        if ( openTag.equals( "DT" ) )
            return tagName.equals( "DD" );
        // DD (DT, closing DL)
        if ( openTag.equals( "DD" ) )
            return tagName.equals( "DT" );
        // LI (LI, closing UL/OL)
        if ( openTag.equals( "LI" ) )
            return tagName.equals( "LI" );
        ...
        if ( openTag.equals( "THEAD" ) || openTag.equals( "TFOOT" ) ||
            ...
            return ( tagName.equals( "THEAD" ) || tagName.equals( "TFOOT" ) ||
                     tagName.equals( "TBODY" ) || tagName.equals( "TR" ) ||
