...
import org.openxml.wml.WMLCardElement;

public class WMLCardElementImpl extends WMLElementImpl implements WMLCardElement {

  public WMLCardElementImpl (DocumentImpl owner, String namespaceURI, String qualifiedName ) { 
  ...
  public String getNewcontext() {
    return getAttribute("newcontext");
  }
