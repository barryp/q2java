...
//                if ( match( entry._string, chars, 0, length ) )
     ...
     */
    private static final int            INITIAL_POOL_SIZE = /*4861*/ 12143;
...
/**
 * Each string in the pool is represented by this entry. The next record
 * is used to chain entries that hash into a single hashtable entry.
 * The last accessed record is used to dispose of old strings.
 */
